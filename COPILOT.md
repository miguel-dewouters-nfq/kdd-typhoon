# COPILOT.md — Typhoon (Market Data Server) Unified AI Context
...
**Fuente**: `ARCH-KYUW-001` ([specs/architecture/ARCH-KYUW-001-typhoon-system-architecture-overview.md](specs/architecture/ARCH-KYUW-001-typhoon-system-architecture-overview.md))
